...
public class UjiTabunganNasabah {
...
public static void main(String[] args) {
	      ...
	      System.out.println("Jumlah yang diambil 6000");
	      if(status)
	      ...
	      System.out.println("Jumlah yang diambil 4000");
	      if(status)
	         System.out.println(" OK");
	      else
	         System.out.println(" Gagal");
	      status=nasabah.getTabungan().ambilUang(1600);
	      System.out.println("Jumlah yang diambil 1600");
	      if(status)
	         System.out.println(" OK");
	      else
	         System.out.println(" Gagal");
